...
class DepthUtil {
	...
	{
		if (obj1.flixelType == FlxType.OBJECT && obj2.flixelType == FlxType.OBJECT) collideObjectWithObject(obj1, obj2);
		else if (obj1.flixelType == FlxType.OBJECT && obj2.flixelType == FlxType.TILEMAP) collideSpriteWithTilemap(cast obj1, cast obj2);
		else if (obj1.flixelType == FlxType.TILEMAP && obj2.flixelType == FlxType.OBJECT) collideSpriteWithTilemap(cast obj2, cast obj1);
	}
